...
const WidgetTemplate: React.FC<{ logo?: React.ReactElement; children: React.ReactNode }> =
    ({ logo, children }) => (
...
const Overview: React.FC = () => {
    ...
    return (
        <div className={style.pageContainer}>
            ...
            <AddWidgetModal isOpen={isModalOpen} onClose={handleCancel} onAddWidget={handleAddWidget} />
        </div>
    );
};
