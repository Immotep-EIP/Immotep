...
const (
	...
	MissingFile                  ErrorCode = "missing-file"
	...
	FailedUploadFile             ErrorCode = "failed-upload-file"
	FailedDeleteFile             ErrorCode = "failed-delete-file"
	...
	FurnitureNotInThisProperty   ErrorCode = "furniture-not-in-this-property"
	InventoryReportAlreadyExists ErrorCode = "inventory-report-already-exists"
	CannotModifyInventoryReport  ErrorCode = "cannot-modify-inventory-report"
	...
	InvalidObjectType            ErrorCode = "invalid-object-type"
