...
import com.example.keyz.apiCallerServices.LeasePropertyResponse
...
import com.example.keyz.inventory.InventoryReportFurniture
import com.example.keyz.inventory.InventoryReportOutput
import com.example.keyz.inventory.InventoryReportRoom
...
val fakeRoom = RoomOutput(
    ...
    name = "testRoomName",
    property_id = "test",
    type = RoomType.bedroom.toString(),
    archived = false
)
...
val fakeInviteOutput = InviteOutput(
    id = "test",
    property_id = "test",
    tenant_email = "test",
    start_date = "test",
...
val fakeRegistrationResponse = RegistrationResponse(
    id = "test",
    email = "test",
    firstname = "test",
    lastname = "test",
